...
ft_itoa.c ft_putchar.c ft_putchar_fd.c ft_putstr.c ft_putstr_fd.c ft_putendl_fd.c \
ft_putnbr.c ft_putnbr_fd.c ft_strmapi.c ft_striteri.c ft_printf.c get_next_line.c \
